...
public class DeerLoot : MonoBehaviour
{
    [System.Serializable]
    public struct LootEntry
    {
        public string itemName;
        public GameObject itemPrefab; // prefab item thả ra
    ...
    [SerializeField] private Collider _lootCollider; // collider riêng cho loot
    ...
    // Gọi từ PlayerInteraction khi player nhấn F/E trên xác nai
    public void OnPlayerLoot(Vector3 dropPosition)
    {
        ...
        // Loot xong thì khóa lại (không loot được nữa)
        SetLootable(false);
        Debug.Log("[DeerLoot] Đã loot xong xác nai.");
    }
}